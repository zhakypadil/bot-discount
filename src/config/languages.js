const languages = {
    en: {
        ...
        // Business flow
        businessRegistration: '🔐 **Business Registration**\n\nWelcome! We\'ll help you set up your business account.\n\nA unique business code will be automatically generated for you.',
        codeGenerated: '🎉 **Business Code Generated!**\n\nYour unique business code: **{code}**\n\nThis code is valid for 1 year and is automatically assigned to your business.',
        codeGenerationFailed: '❌ **Code Generation Failed**\n\nUnable to generate a business code at this time. Please try again.',
    ...
    ru: {
        ...
        // Business flow
        businessRegistration: '🔐 **Регистрация бизнеса**\n\nДобро пожаловать! Мы поможем вам настроить бизнес-аккаунт.\n\nУникальный код бизнеса будет автоматически сгенерирован для вас.',
        codeGenerated: '🎉 **Код бизнеса сгенерирован!**\n\nВаш уникальный код бизнеса: **{code}**\n\nЭтот код действителен 1 год и автоматически присваивается вашему бизнесу.',
        codeGenerationFailed: '❌ **Ошибка генерации кода**\n\nНе удалось сгенерировать код бизнеса в данный момент. Пожалуйста, попробуйте снова.',
    ...
    kk: {
        ...
        // Business flow
        businessRegistration: '🔐 **Бизнес тіркеуі**\n\nҚош келдіңіз! Біз сізге бизнес-есептік жазуды баптауға көмектесеміз.\n\nБірегей бизнес коды сіз үшін автоматты түрде жасалады.',
        codeGenerated: '🎉 **Бизнес коды жасалды!**\n\nСіздің бірегей бизнес кодыңыз: **{code}**\n\nБұл код 1 жылға жарамды және сіздің бизнесіңізге автоматты түрде тағайындалады.',
        codeGenerationFailed: '❌ **Код жасау сәтсіз**\n\nҚазіргі уақытта бизнес кодын жасау мүмкін емес. Қайталап көріңіз.',
        ...
        contactPhone: '📞 **Байланыс телефоны**\n\nБизнес телефон нөміріңізді енгізіңіз:',
